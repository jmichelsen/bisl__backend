...
class MessageManager(models.Manager):
    ...
    def inbox_for(self, user):
        ...
        :return: all messages received by given user & are not marked deleted
        """
    ...
    def outbox_for(self, user):
        ...
        :param user: current User
        :return: all messages sent by given user & are not deleted
        """
    ...
    def trash_for(self, user):
        ...
        :param user: current User
        :return: all deleted messages that were sent OR received
        """
...
class Message(models.Model):
    ...
    receiver = models.ForeignKey(AUTH_USER_MODEL, related_name='received_messages',
